...
export function WhatsAppButton() {
  return (
    ...
    >
      ...
      <span className="absolute right-20 bg-white text-black font-bold text-sm px-4 py-2 rounded-xl whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity duration-300 shadow-xl pointer-events-none before:content-[''] before:absolute before:top-1/2 before:-right-2 before:-translate-y-1/2 before:border-8 before:border-transparent before:border-l-white">
        Precisa de Ajuda?
      </span>
