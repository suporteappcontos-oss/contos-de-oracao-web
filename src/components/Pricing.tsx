    ...
    <section id="planos" className="py-[80px] px-[4%] text-center bg-[#111]">
      ...
      <div className="flex flex-col md:flex-row justify-center items-center md:items-stretch flex-wrap gap-[30px]">
        ...
        <div className="bg-card p-[40px] rounded-[16px] w-full max-w-[320px] relative transition-transform duration-300 border-2 border-transparent flex flex-col hover:-translate-y-2.5">
          <h3 className="text-[1.8rem] mb-2.5 text-text-muted font-bold text-left">Básico</h3>
          <p className="text-4xl font-extrabold mb-[30px] text-white text-left">
            R$ 25,90 <span className="text-[1.2rem] font-normal text-text-muted">/mês</span>
          </p>
          ...
          <button className="w-full p-[15px] rounded-lg border-none bg-white/10 text-white font-semibold text-[1.2rem] cursor-pointer transition-all hover:bg-primary hover:text-black active:scale-95">
            Assinar Básico
          </button>
        </div>

        {/* Plano Padrão (Highlight) */}
        <div className="bg-gradient-to-br from-[#222] to-[#2a0b0e] p-[40px] rounded-[16px] w-full max-w-[320px] relative transition-transform duration-300 border-2 border-primary shadow-[0_8px_40px_rgba(229,9,20,0.2)] flex flex-col md:scale-105 z-10 hover:-translate-y-2.5">
          ...
          <h3 className="text-[1.8rem] mb-2.5 text-primary font-bold text-left">Padrão</h3>
          <p className="text-4xl font-extrabold mb-[30px] text-white text-left">
            R$ 39,90 <span className="text-[1.2rem] font-normal text-text-muted">/mês</span>
          </p>
          <ul className="list-none mb-[40px] text-left grow">
          ...
          <button className="w-full p-[15px] rounded-lg border-none bg-primary text-black font-extrabold text-[1.2rem] cursor-pointer transition-all active:scale-95">
            Assinar Padrão
          </button>
        </div>
        ...
        {/* Plano Premium */}
        <div className="bg-card p-[40px] rounded-[16px] w-full max-w-[320px] relative transition-transform duration-300 border-2 border-transparent flex flex-col hover:-translate-y-2.5">
          <h3 className="text-[1.8rem] mb-2.5 text-text-muted font-bold text-left">Premium</h3>
          <p className="text-4xl font-extrabold mb-[30px] text-white text-left">
            R$ 55,90 <span className="text-[1.2rem] font-normal text-text-muted">/mês</span>
          </p>
          <ul className="list-none mb-[40px] text-left grow">
