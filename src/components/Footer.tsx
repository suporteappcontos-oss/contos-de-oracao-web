  ...
  return (
    ...
    >
      ...
      <style dangerouslySetInnerHTML={{__html: `
        ...
        /* Setinha do tooltip apontando para cima */
        .social-wrapper .tooltip::before {
          ...
          width: 8px;
          background: #fff;
          top: -3px; /* Fica no topo do tooltip apontando pra cima */
          left: 50%;
          transform: translate(-50%) rotate(45deg);
          transition: all 0.3s cubic-bezier(0.68, -0.55, 0.265, 1.55);
        }

        /* Tooltip aparece EMBAIXO no hover */
        ...
        .social-wrapper .instagram { background: linear-gradient(135deg,#833AB4,#FD1D1D,#FCB045); }
        .social-wrapper .facebook { background: #1877F2; }
        .social-wrapper .tiktok { background: #000000; border: 1px solid rgba(255, 255, 255, 0.15); }
        .social-wrapper .youtube { background: #FF0000; }

        /* Cores do Tooltip no Hover para cada rede */
        ...
        /* Animação do ícone em si (subir um pouquinho) */
